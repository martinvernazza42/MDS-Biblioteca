...
class SocioCreateView(CreateView):
    ...
    def form_valid(self, form):
        ...
        try:
            ...
            form.add_error('dni', f'Ya existe un socio con este DNI: {socio_existente.nombre_completo} (Número: {socio_existente.numero_socio})')
        ...
        try:
            ...
            messages.success(self.request, f'Socio creado exitosamente. Número de socio: {self.object.numero_socio}')
            return response
